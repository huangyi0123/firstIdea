...
def main():
    result=getData('select TA_ID,TA_Name from Tactic_PRE_ATTCK')
    dit = {}
    ...
    sheet1 = book1.add_sheet("Tactic_PRE_ATTCK")#创建工作表
    #统计
    sheet1.write(0, 0, "合计")
    ...
    for d in dit:
        ...
        r += 1
    book1.save("F:/研究生毕设/experimentalCode/firstIdea/Data/dataDuplication/Tactic_PRE_ATTCK.xls")


def techniqueTacticPREATTCKAssociation():
    result=getData("select * from Tactic_PRE_ATTCK")
    technique=[]
    ...
    book1.save("F:/研究生毕设/experimentalCode/firstIdea/Data/dataAssociation/techniqueTacticPREATTCKAssociation.xls")


if __name__=="__main__":
    main()
    techniqueTacticPREATTCKAssociation()
