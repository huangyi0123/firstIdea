...
def techniquePREATTCKAssociation():
    result = getData('SELECT T_ID,T_Title,T_Tactic FROM Technique_PRE_ATTCK')
    ...
    book1 = xlwt.Workbook()  # 创建excel
    sheet1 = book1.add_sheet("TechniquePRE_ATTCK_Association")  # 创建工作表
    # 统计
    sheet1.write(0, 0, "合计")
    sheet1.write(0, 1, len(dit))
    #表头
    ...
    for d in dit:
        ...
        r += 1
    book1.save("F:/研究生毕设/experimentalCode/firstIdea/Data/dataAssociation/TechniquePRE_ATTCK_Association.xls")


if __name__=="__main__":
    main()
    techniquePREATTCKAssociation()