...
def main():
    result=getData('select TA_ID,TA_Name from Tactic_Mobile')
    dit = {}
    ...
    sheet1 = book1.add_sheet("Tactic_Mobile")#创建工作表
    #统计
    sheet1.write(0, 0, "合计")
    ...
    for d in dit:
        ...
        r += 1
    book1.save("F:/研究生毕设/experimentalCode/firstIdea/Data/dataDuplication/Tactic_Mobile.xls")

def techniqueTacticMobileAssociation():
    result=getData("select * from Tactic_Mobile")
    technique=[]
    ...
    book1.save("F:/研究生毕设/experimentalCode/firstIdea/Data/dataAssociation/techniqueTacticMobileAssociation.xls")



if __name__=="__main__":
    main()
    techniqueTacticMobileAssociation()